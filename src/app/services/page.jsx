...
const itemsContent = [
  {
    ...
    caption: (
      <>
        Layanan konsultasi arsitektural yang diberikan oleh Urbia mengedepankan
        bagaimana perencanaan properti yang dibutuhkan klien. Klien akan
        dilibatkan dalam proses pengambilan keputusan pada perencanaan. Adalah
        tanggung jawab Urbia, klien dapat memahami secara baik apa yang sedang
        ia rencanakan. Terlebih pada kebutuhan komersial, Urbia memberikan
        prioritas pada identifikasi alternatif desain yang mempertimbangkan
        berbagai aspek, seperti efisiensi ruang, keberlanjutan, dan valuasi
        properti. Urbia bersama dengan klien akan mengeksplorasi apa saja yang
        menjadi prioritas perencanaan, tujuan perencanaan, pengguna dan
        aktivitas pada properti yang direncanakan, daya tampung yang akan
        diakomodasi dalam perencanaan, bahkan nilai komersial yang melekat pada
        properti. <br />
        <br />
        <b>
          Kami berusaha menggali dan memahami apa yang sebenarnya Anda butuhkan
          dalam perencanaan.
        </b>{" "}
        Dalam perencanaan, terdapat beberapa langkah yang akan dilakukan. Secara
        umum perencanaan merupakan proses konsultasi oleh klien terhadap
        kebutuhan dan keinginan dalam memiliki dan/atau membangun sebuah
        properti. Tentunya, Urbia akan mendalami materi yang disesuaikan dengan
        konteks kebutuhan klien. Properti merupakan item/unit yang memiliki
        nilai investasi dan kapital yang tidak sedikit, maka Urbia berupaya
        untuk memberikan rekomendasi dan arahan terhadap klien sehingga dapat
        mendapatkan perencanaan properti yang efektif dan efisien.
      </>
    ),
  },
  {
    ...
    caption: (
      <>
        ...
        perencanaan yang baik juga. Kami memahami bahwa proses konstruksi bukan
        hal mudah untuk dipahami, pun juga kami memahami keinginan klien
        ...
        <br />
        Konstruksi dilakukan setidaknya setelah proses perencanaan selesai. Hal
        ini dikarenakan proses konstruksi maupun renovasi melibatkan banyak
        sekali pihak. Mulai dari penyedia bahan dan material, penyedia tenaga
        kerja tukang, vendor-vendor, maupun penyedia jasa konstruksi itu
        sendiri. Terdapat beberapa aspek yang akan diperhatikan sebelum akan
        memulai proses konstruksi, yaitu :
  ...
  },
  {
    ...
    caption: (
      <>
        ...
        yang tepat dalam merencanakan kebutuhan propertinya. Hal ini penting dan
        akan berkaitan dengan implementasi desain secara langsung. Misalnya
        luasan bangunan yang perlu direncanakan, masa pembangunan yang tepat,
        kapasitas dalam desain, hingga keterlibatan stakeholder apabila
        diperlukan. Bahkan pada sebagian project, branding dan target market
        menjadi salah satu variabel yang harus dieksplorasi sebagai materi dalam
        merencanakan properti.
        <br /> <br />
        Urbia juga siap dalam bekerjasama dengan kontraktor maupun pengembang
        dalam merencanakan projectnya. Terdapat beberapa pengembang yang pernah
        bekerjasama dengan Urbia dalam merencanakan kawasan, residensial, hingga
        fasilitas umum dan sosialnya.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    caption: (
      <>
        ...
        skala yang cukup besar. Disisin lain, arsitektur juga hadir dalam
        berbagai aspek keruangan. Berbagai isu dan juga fenomena yang berkaitan
        dengan keruangan ada di sekitar kita. Banyak yang belum mengetahui
        tentang bagaimana ruang yang baik itu dihadirkan. Tidak semua orang
        memperhatikan bagaimana ruang sebaiknya dimanfaatkan. Tidak semua
        kalangan mengetahui kondisi kelompok masyarakat tertentu yang sebenarnya
        memerlukan penanganan ruang yang lebih kondusif. Tidak semua masyarakat
        menyadari bahwa kepentingan umum itu harus didahulukan. <br />
        <br />
        Urbia memiliki kepentingan dalam menyebarluaskan awareness terkait ruang
        dan manusia yang memanfaatkannya. Harapannya, semakin banyak orang yang
        terbuka wawasannya. Terlebih lagi, kami memiliki tujuan dalam bertemu
        ...
        disebarluaskan dengan memanfaatkan media cetak maupun digital yang
        disediakan oleh Urbia kepada khalayak umum.
      </>
    ),
  },
];
