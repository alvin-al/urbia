...
const OverlayMenu = ({ isOpen }) => {
  return (
    <div className={`h-full w-full fixed z-10 left-0 top-0 bg-black overflow-x-hidden flex items-center justify-center pt-[15%] sm:pt-[5%] lg:pt-0 transition-opacity duration-200 ${isOpen ? 'opacity-100' : 'opacity-0'} `}>
